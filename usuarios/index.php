...
<body>
    ...
    <form id="formRegistro" class="form-group container" autocomplete="off" @submit.prevent="registro"
            ...
            <div class="form-group btn-lg col-md-6">
                ...
                <input type="text" class="form-control" name="nombreUsuario" placeholder="Nombre Usuario" require>
            </div>
            <div class="form-group btn-lg col-md-6">
                <label>Clave Usuario</label>
                <input type="text" class="form-control" name="claveUsiario" placeholder="Clave Usuario" require>
            </div>
